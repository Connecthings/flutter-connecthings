...
public class HerowPlugin implements MethodCallHandler, EventChannel.StreamHandler {
  ...
  public void onMethodCall(MethodCall call, Result result) {
    ...
    if (call.method.equals("optinsNeverAsked")) {
      result.success(herowInitializer.optinsNeverAsked());
    } else if (call.method.equals("updateOptin")) {
    ...
    } else if (call.method.equals("allOptinsAreUpdated")) {
      herowInitializer.allOptinsAreUpdated();
    } else if (call.method.equals("isOptinAuthorized")) {
